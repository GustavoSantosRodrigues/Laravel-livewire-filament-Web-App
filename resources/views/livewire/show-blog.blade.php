            ...
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    ...
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        <li class="list-inline-item"><a href="{{ route('home.page') }}">Home</a>
                        </li>
                        <li class="list-inline-item">/ &nbsp; <a href="{{ route('blog.page') }}">Blog</a>
                        </li>
                    </ul>
                </div>
            </div>
                                    ...
                                    <div class="col-md-6" data-aos="fade">
                                        ...
                                        <article class="blog-post">
                                            <div class="post-slider slider-sm rounded">
                                                ...
                                                @else
                                                    <img loading="lazy" decoding="async"
                                                        src="{{ asset('/front/images/blog/post-1.jpg') }}"
                                                        alt="Post Thumbnail"
                                                        style="width: 400px; height: 300px; object-fit: contain;">
                                                @endif
                                            ...
                                            <div class="pt-4">
                                                ...
                                                <h2 class="h4"><a class="text-black"
                                                        href="blog-details.html">{{ $article->title }}</h2>
                                                <p>{!! $article->content !!}</p>
                ...
                <div class="col-lg-3">
                        ...
                        <ul class="list-unstyled widget-list">
                            @if ($categories->isNotEmpty())
                                @foreach ($categories as $category)
                                    <li>
                                        <a wire:navigate
                                            href="{{ route('blog.page') . '?categorySlug=' . $category->slug }}">{{ $category->name }}</a>
                                    </li>
                                @endforeach
                            @endif
                    ...
                    <div class="widget">
                        ...
                        @if ($latestArticles->isNotEmpty())
                            @foreach ($latestArticles as $lastArticle)
                                <ul class="list-unstyled widget-list">
                                        ...
                                        <a class="text-black" href="/blog/elements/">
                                            <div class="widget-post-image flex-shrink-0 me-3">
                                                ...
                                                <img class="rounded" loading="lazy" decoding="async"
                                                    src="{{ asset('storage/' . $lastArticle->image) }}"
                                                    alt="Post Thumbnail">
                                                @else
                                                    <img src="{{ asset('/front/images/blog/post-1.jpg') }}" alt="padrao">
                                                @endif
                                            </div>
                                        </a>
                                        <div class="flex-grow-1">
                                            <h5 class="h6 mb-0"><a class="text-black"
                                                    href="blog-details.html">{{ $lastArticle->title }}</a></h5>
                                            <small>{{ \Carbon\Carbon::parse($lastArticle->created_at)->format('d/m/Y') }}</small>
                                        </div>
                                    </li>
                                </ul>
                            @endforeach
